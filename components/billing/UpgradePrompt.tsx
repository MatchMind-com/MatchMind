...
export default function UpgradePrompt({ feature, requiredTier = 'pro' }: { feature: string; requiredTier?: 'pro' | 'elite' }) {
  ...
  return (
    <div className="flex flex-col items-center justify-center p-8 text-center bg-gradient-to-b from-violet-950/30 to-transparent border border-violet-500/20">
      ...
      <button
        ...
        className="px-6 py-2.5 bg-violet-600 hover:bg-violet-500 text-white text-sm font-semibold transition-colors"
      >
