...
export default function ReferralClient({ referralCode, referralCount, subscriptionTier }: Props) {
  ...
  return (
    <div className="p-4 md:p-8 max-w-2xl mx-auto">
      ...
      {/* Progress */}
      <div className="bg-white/[0.03] border border-white/8 p-5 mb-5">
      ...
      <div className="grid grid-cols-2 gap-3">
        <a
          ...
          className="flex items-center justify-center gap-2 bg-[#25D366]/10 hover:bg-[#25D366]/20 border border-[#25D366]/25 text-[#25D366] font-semibold text-sm py-3 transition-colors"
        >
